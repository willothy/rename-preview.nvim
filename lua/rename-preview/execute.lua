...
function M.run(opts)
  ...
  -- Review mode: a single, conflict-free site may be applied without the window
  -- when the user has opted into that shortcut.
